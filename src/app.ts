...
import { authRouter, categoryRouter, userRouter, ProducServiceRouter, locationRouter, orderRouter, chatRouter, reactionRouter, productReviewRoutes, userReviewRoutes, brandingRouter } from "./api/v1/routes";
...
// Branding — GET is public, mutations are guarded inside the router
app.use((`${apiPathAndVersion}/branding`), brandingRouter);
